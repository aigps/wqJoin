...
public class WqStaffInfo {
    ...
    private String isCompanySignIn;

    private String isClientSignIn;

    private String isCompanySignOut;

    private String isClientSignOut;
    ...
    public String getIsCompanySignIn() {
        return isCompanySignIn;
    }

    public void setIsCompanySignIn(String isCompanySignIn) {
        this.isCompanySignIn = isCompanySignIn;
    }

    public String getIsClientSignIn() {
        return isClientSignIn;
    }

    public void setIsClientSignIn(String isClientSignIn) {
        this.isClientSignIn = isClientSignIn;
    }

    public String getIsCompanySignOut() {
        return isCompanySignOut;
    }

    public void setIsCompanySignOut(String isCompanySignOut) {
        this.isCompanySignOut = isCompanySignOut;
    }

    public String getIsClientSignOut() {
        return isClientSignOut;
    }

    public void setIsClientSignOut(String isClientSignOut) {
